...
- For one inner catheter, compare proximal OD `<=` proximal ID minus 0.001 inch, and distal OD `<=` distal ID minus 0.001 inch. Both inclusive boundaries use exact decimal subtraction without added tolerance.
