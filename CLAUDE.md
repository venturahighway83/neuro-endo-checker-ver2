...
- For one inner catheter, compare proximal OD `<=` proximal ID minus 0.001 inch, and distal OD `<` distal ID minus 0.001 inch. The inclusive proximal boundary uses exact decimal subtraction without added tolerance.
